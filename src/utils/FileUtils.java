...
public class FileUtils {
	...
	public static Color[][] loadTestImage() {
		return loadImage(INPUT_FILE_NAME);
	}

	public static void writeTestImage(Color[][] image) {
	 ...
	 * @return Color matrix.
	 */
	private static Color[][] loadImage(String filename) {
	 ...
	 */
	private static void writeImage(Color[][] image, String filename) {
		File outputfile = new File(filename);
		var bufferedImage = FileUtils.matrixToBuffered(image);
